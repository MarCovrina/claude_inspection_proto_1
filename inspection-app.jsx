...
const initialTechPlaces = [
  {
    ...
    stages: [
      { 
        ...
        inspected: true,
        defects: [
          { id: 1, name: 'Коррозия на корпусе', severity: 'none', photos: [], comment: '' },
          { id: 2, name: 'Утечка масла', severity: 'medium', photos: [], comment: 'Небольшая утечка' },
        ]
      },
      { 
        id: 2, 
        ...
        inspected: true,
        defects: [
          { id: 3, name: 'Превышение давления', severity: 'none', photos: [], comment: '' },
        ]
      },
      { 
        id: 3, 
        name: 'Измерение вибрации', 
        inspected: false,
        defects: [
          { id: 4, name: 'Повышенная вибрация', severity: 'none', photos: [], comment: '' },
          { id: 5, name: 'Шум подшипников', severity: 'none', photos: [], comment: '' },
        ]
      },
    ]
  },
  {
    ...
    stages: [
      { 
        ...
        inspected: false,
        defects: [
          { id: 6, name: 'Повреждение изоляции', severity: 'none', photos: [], comment: '' },
        ]
      },
      { 
        id: 5, 
        ...
        inspected: false,
        defects: [
          { id: 7, name: 'Низкое сопротивление', severity: 'none', photos: [], comment: '' },
        ]
      },
    ]
  },
  {
    id: 3,
    name: 'Вентиляционная установка В-3',
    type: 'Вентиляция',
    stages: [
      { 
        id: 6, 
        name: 'Осмотр фильтров', 
        inspected: true,
        defects: [
          { id: 8, name: 'Загрязнение фильтра', severity: 'high', photos: [], comment: 'Требуется замена' },
          { id: 9, name: 'Деформация корпуса', severity: 'low', photos: [], comment: '' },
        ]
      },
      { 
        id: 7, 
        ...
        inspected: false,
        defects: [
          { id: 10, name: 'Перегрев двигателя', severity: 'none', photos: [], comment: '' },
        ]
      },
      { 
        id: 8, 
        name: 'Тестирование автоматики', 
        inspected: false,
        defects: [
          { id: 11, name: 'Сбой датчиков', severity: 'none', photos: [], comment: '' },
        ]
      },
    ]
  },
  {
    id: 4,
    name: 'Котел отопления К-2',
    type: 'Теплоснабжение',
    stages: [
      { 
        id: 9, 
        name: 'Проверка горелки', 
        inspected: false,
        defects: [
          { id: 12, name: 'Засорение форсунок', severity: 'none', photos: [], comment: '' },
        ]
      },
    ]
  },
